        ...
        <section className="rounded-xl border border-stone-200 bg-white p-5 sm:p-6">
            ...
            <div className="mt-6 flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-4 sm:flex-row">
                    ...
                    <Field error={errors.postal_code} label={t('postal_code')} name="postal_code" onChange={onChange} value={data.postal_code} />
                </div>
                <div className="flex flex-col gap-4 sm:flex-row">
                    ...
                    <Field error={errors.phone} label={t('phoneNumber')} name="phone" onChange={onChange} value={data.phone} />
                </div>
            </div>
        </section>
    );
