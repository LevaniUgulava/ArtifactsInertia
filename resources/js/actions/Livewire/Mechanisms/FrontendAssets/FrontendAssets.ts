...
* @route '/livewire-5e4447f4/livewire.js'
*/
...
returnJavaScriptAsFile.definition = {
    methods: ["get","head"],
    url: '/livewire-5e4447f4/livewire.js',
...
* @route '/livewire-5e4447f4/livewire.min.js.map'
*/
...
maps.definition = {
    methods: ["get","head"],
    url: '/livewire-5e4447f4/livewire.min.js.map',
} satisfies RouteDefinition<["get","head"]>
...
* @route '/livewire-5e4447f4/livewire.csp.min.js.map'
*/
...
cspMaps.definition = {
    methods: ["get","head"],
    url: '/livewire-5e4447f4/livewire.csp.min.js.map',
} satisfies RouteDefinition<["get","head"]>
