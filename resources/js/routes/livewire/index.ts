...
* @route '/livewire-5e4447f4/upload-file'
*/
...
uploadFile.definition = {
    methods: ["post"],
    url: '/livewire-5e4447f4/upload-file',
...
* @route '/livewire-5e4447f4/preview-file/{filename}'
*/
...
previewFile.definition = {
    methods: ["get","head"],
    url: '/livewire-5e4447f4/preview-file/{filename}',
